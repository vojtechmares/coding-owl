...
| [0038](0038-shifts.md) | A Shift lets Owl work on an Account while the machine is in use | Accepted |
| [0039](0039-focus.md) | Each Account may have one Focus, a Project whose Jobs go first | Accepted |
